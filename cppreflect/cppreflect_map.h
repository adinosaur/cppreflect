#ifndef CPPREFLECT_MAP_H
#define CPPREFLECT_MAP_H
...
struct MapClass : public ClassTemplate
{
...
const Class* GetClassImpl(ClassTag<std::map<K, V> >)
{
    ...
    static MapClass<std::map<K, V> > mapClass {
        "std::map<K, V>",               /* m_name */
        sizeof(std::map<K, V>),         /* m_size */
        0,                              /* m_hash */
        NULL,                           /* m_baseClass */
        {},                             /* m_fields */
        {},                             /* m_functions */
...
template<class K, class V>
const Type* GetTypeImpl(TypeTag<std::map<K, V> >)
{
    return GetClassImpl(ClassTag<std::map<K, V> >{});
}

} /* namespace detail */
} /* namespace cppreflect */

#endif /* CPPREFLECT_MAP_H */